                ...
                {{-- Nominal --}}
                    <div class="col-md-4">
                        ...
                        <input type="text" name="nominal_advance" id="nominal_advance" class="form-control form-control-sm"
                            value="{{ number_format(old('nominal_advance', $advance->nominal ?? 0), 0, ',', '.') }}" readonly>
                    </div>
                    <div class="col-md-4">
                        <label class="form-label form-label-sm">Nominal Settlement (Rp)</label>
                        <input type="text" name="nominal_settlement" id="nominal_settlement" class="form-control form-control-sm" readonly>
                    </div>
                    <div class="col-md-4">
                        <label class="form-label form-label-sm">Difference (Rp)</label>
                        <input type="text" name="difference" id="difference" class="form-control form-control-sm" readonly>
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea name="description" rows="2" class="form-control form-control-sm"
                                required>{{ old('description', $advance->description ?? '') }}</textarea>
                    </div>
                </div>

                {{-- Tabel Rincian Penggunaan --}}
                <div class="mt-4">
                    <label class="form-label form-label-sm">Rincian Penggunaan</label>
                    ...
                    <button type="button" class="btn btn-sm btn-secondary" id="addItem">+ Tambah Item</button>
                </div>
